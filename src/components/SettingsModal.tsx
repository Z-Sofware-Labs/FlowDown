...
export const SettingsModal: React.FC<SettingsModalProps> = ({
  ...
  return (
    <div className="fixed inset-0 z-50 bg-slate-900/60 backdrop-blur-xs flex items-center justify-center p-4">
      <div className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-2xl w-full max-w-4xl shadow-2xl overflow-hidden animate-in fade-in zoom-in-95 duration-200 text-slate-800 dark:text-slate-100 flex flex-col max-h-[92vh]">
        
        {/* Header */}
        <div className="flex items-center justify-between px-6 py-3.5 border-b border-slate-200 dark:border-slate-800 bg-slate-50/80 dark:bg-slate-800/80 shrink-0">
        ...
        <div className="p-6 text-xs overflow-y-auto">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-5 items-stretch">
            {/* Left Column: General & Download Manager Preferences */}
            <div className="flex flex-col justify-between h-full space-y-4">
              ...
              <div className="space-y-1.5">
                ...
                <div className="grid grid-cols-2 gap-2.5">
                  <button
                    ...
                    className={`flex items-center justify-center space-x-2.5 py-2.5 px-3.5 rounded-xl border text-xs font-semibold transition-all cursor-pointer shadow-sm ${
                      settings.theme === 'light'
                        ? 'bg-amber-50 dark:bg-slate-800 border-amber-400 dark:border-amber-500 text-slate-900 dark:text-white ring-2 ring-amber-400/20'
                  ...
                  <button
                    ...
                    className={`flex items-center justify-center space-x-2.5 py-2.5 px-3.5 rounded-xl border text-xs font-semibold transition-all cursor-pointer shadow-sm ${
                      settings.theme === 'dark'
                        ? 'bg-indigo-900/40 border-indigo-500 text-slate-900 dark:text-white ring-2 ring-indigo-500/20'
                        : 'bg-slate-50 dark:bg-slate-800/50 border-slate-200 dark:border-slate-700 text-slate-600 dark:text-slate-400 hover:bg-slate-100 dark:hover:bg-slate-800'
                    }`}
                  >
              ...
              {/* Bandwidth & Queue Settings */}
              <div className="grid grid-cols-2 gap-2.5">
                {/* Max Simultaneous Transfers */}
                <div className="space-y-1.5">
                  <label className="text-[11px] font-bold text-slate-400 dark:text-slate-500 uppercase tracking-wider flex items-center space-x-1.5">
                  ...
                  <select
                    ...
                    className="w-full bg-slate-50 dark:bg-slate-800/80 border border-slate-200 dark:border-slate-700 focus:border-blue-500 focus:bg-white dark:focus:bg-slate-900 rounded-xl px-3 py-2 text-slate-800 dark:text-slate-100 text-xs focus:outline-none cursor-pointer shadow-sm font-medium"
                  >
                    <option value={1}>1 File (Sequential)</option>
                    <option value={2}>2 Files</option>
                    <option value={3}>3 Files (Default)</option>
                    <option value={5}>5 Files</option>
                    <option value={10}>10 Files (High Bandwidth)</option>
                  </select>
                </div>
                ...
                <div className="space-y-1.5">
                  ...
                  <select
                    ...
                    className="w-full bg-slate-50 dark:bg-slate-800/80 border border-slate-200 dark:border-slate-700 focus:border-blue-500 focus:bg-white dark:focus:bg-slate-900 rounded-xl px-3 py-2 text-slate-800 dark:text-slate-100 text-xs focus:outline-none cursor-pointer font-mono shadow-sm"
                  >
                    <option value={0}>Unlimited</option>
                    <option value={2000000}>2 MB/s</option>
                    <option value={5000000}>5 MB/s</option>
                    <option value={10000000}>10 MB/s</option>
                    <option value={25000000}>25 MB/s</option>
                  </select>
                </div>
              </div>
              ...
              <div className="space-y-1.5">
                ...
                <input
                  ...
                  className="w-full bg-slate-50 dark:bg-slate-800/80 border border-slate-200 dark:border-slate-700 focus:border-blue-500 focus:bg-white dark:focus:bg-slate-900 rounded-xl px-3 py-2 text-slate-800 dark:text-slate-100 font-mono text-xs focus:outline-none transition-all shadow-sm"
                />
              </div>

              {/* Checkbox Options */}
              <div className="space-y-2 pt-0.5">
                <label className="flex items-start space-x-3 cursor-pointer p-3 rounded-xl bg-slate-50 dark:bg-slate-800/50 border border-slate-200 dark:border-slate-700/80 hover:bg-slate-100 dark:hover:bg-slate-800 transition-colors shadow-sm">
                  <input
                    type="checkbox"
                    checked={settings.hardwareAcceleration ?? true}
                    onChange={(e) => onUpdateSettings({ hardwareAcceleration: e.target.checked })}
                    className="mt-0.5 rounded border-slate-300 dark:border-slate-700 text-blue-600 focus:ring-blue-500 h-4 w-4 cursor-pointer"
                  />
                  <div className="flex flex-col space-y-0.5">
                    ...
                    <span className="text-[11px] text-slate-500 dark:text-slate-400 leading-relaxed">
                      Reduces CPU overhead during simultaneous active network transfers
                    </span>
                  </div>
                </label>
                ...
                <label className="flex items-start space-x-3 cursor-pointer p-3 rounded-xl bg-slate-50 dark:bg-slate-800/50 border border-slate-200 dark:border-slate-700/80 hover:bg-slate-100 dark:hover:bg-slate-800 transition-colors shadow-sm">
                  ...
                  <div className="flex flex-col space-y-0.5">
                    ...
                    <span className="text-[11px] text-slate-500 dark:text-slate-400 leading-relaxed">
                      Keep active downloads running in background when window is closed/minimized
                    </span>
                  </div>
                </label>

                <div className="grid grid-cols-1 sm:grid-cols-2 gap-2 pt-0.5">
                  <label className="flex items-center space-x-2.5 cursor-pointer p-2.5 rounded-xl bg-slate-50 dark:bg-slate-800/50 border border-slate-200 dark:border-slate-700/70 hover:bg-slate-100 dark:hover:bg-slate-800/80 transition-colors shadow-sm">
                    <input
                      type="checkbox"
                    ...
                    />
                    <span className="text-slate-700 dark:text-slate-200 text-xs font-medium leading-tight">Auto-start queued items</span>
                  </label>
                  ...
                  <label className="flex items-center space-x-2.5 cursor-pointer p-2.5 rounded-xl bg-slate-50 dark:bg-slate-800/50 border border-slate-200 dark:border-slate-700/70 hover:bg-slate-100 dark:hover:bg-slate-800/80 transition-colors shadow-sm">
                    <input
                      ...
                      className="rounded border-slate-300 dark:border-slate-700 text-blue-600 focus:ring-blue-500 h-4 w-4 cursor-pointer"
                    />
                    <span className="text-slate-700 dark:text-slate-200 text-xs font-medium leading-tight flex items-center space-x-1.5">
                      <Volume2 className="h-3.5 w-3.5 text-amber-500 shrink-0" />
                      <span>Sound alert on completion</span>
                    </span>
                  </label>
                </div>
              </div>
            ...
            {/* Right Column: librqbit Stealth Protocol, File Associations & Updates */}
            <div className="flex flex-col justify-between h-full space-y-4">
              {/* librqbit Stealth Traffic & Privacy Configuration */}
              <div className="bg-teal-50/80 dark:bg-teal-950/40 border border-teal-200 dark:border-teal-900/60 rounded-xl p-3.5 space-y-2.5">
                ...
                <p className="text-[10.5px] text-teal-700/90 dark:text-teal-300/80 leading-relaxed">
                  Enables packet-level header encryption, non-standard listening ports, and client ID anonymization for BitTorrent traffic.
                </p>

                <div className="space-y-1.5 pt-0.5 text-slate-700 dark:text-slate-300">
                  ...
                  <label className="flex items-center space-x-2 cursor-pointer pl-5">
                    ...
                    />
                    <span className="text-slate-600 dark:text-slate-400 text-[11px]">
                      Anonymous Mode (Masks Peer ID fingerprint & User-Agent)
                    </span>
                  </label>
                  ...
                  <label className="flex items-center space-x-2 cursor-pointer pl-5">
                    ...
                    />
                    <span className="text-slate-600 dark:text-slate-400 text-[11px]">
                      Disable DHT / Public Discovery (Strict Tracker Mode)
                    </span>
                  </label>
                </div>

                {/* Custom Listening Port Configuration */}
                <div className="pt-2 border-t border-teal-200/60 dark:border-teal-900/60 flex items-center justify-between gap-2 flex-wrap">
                  <div className="flex items-center space-x-2">
                    ...
                    <input
                      ...
                      className="w-24 bg-white dark:bg-slate-900 border border-teal-300 dark:border-teal-800 rounded-lg px-2 py-1 text-xs font-mono text-slate-800 dark:text-slate-100 focus:outline-none focus:ring-1 focus:ring-teal-500"
                    />
                    <button
                      type="button"
                      onClick={() => {
                      ...
                      className="text-[10.5px] font-medium text-teal-700 dark:text-teal-300 hover:text-teal-900 dark:hover:text-teal-100 flex items-center space-x-1 cursor-pointer"
                    >
                  ...
                  <label className="flex items-center space-x-1.5 cursor-pointer text-[10.5px] text-slate-600 dark:text-slate-400">
                    <input
                      type="checkbox"
                      checked={settings.torrentRandomizePort ?? false}
                      onChange={(e) => onUpdateSettings({ torrentRandomizePort: e.target.checked })}
                      className="rounded border-teal-300 text-teal-600 focus:ring-teal-500 h-3 w-3 cursor-pointer"
                    />
                    <span>Randomize on launch</span>
                  </label>
                </div>
              </div>
                      ...
                      <div className="flex items-center space-x-2">
                        ...
                        <div>
                          ...
                          {torrentAssocStatus === 'registered' && (
                            <p className="text-[10.5px] text-emerald-600 dark:text-emerald-400">✓ Registered successfully</p>
                          )}
                          {torrentAssocStatus === 'removed' && (
                            <p className="text-[10.5px] text-slate-500 dark:text-slate-400">Association removed</p>
                          )}
                          {torrentAssocStatus === 'error' && (
                            <p className="text-[10.5px] text-red-500 dark:text-red-400">Failed — try again</p>
                          )}
                        </div>
                      </div>
              ...
              <div className="space-y-1.5">
                ...
                <div className="flex items-center justify-between p-3 bg-slate-50 dark:bg-slate-800/40 rounded-xl border border-slate-200/80 dark:border-slate-700/80">
                  <div>
                    <p className="text-xs font-semibold text-slate-800 dark:text-slate-200">
                      Current Version: <span className="font-mono text-blue-600 dark:text-blue-400">v1.0.2</span>
                    </p>
